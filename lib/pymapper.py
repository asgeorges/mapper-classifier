...
def pymapper(FILE_TRAIN, FILE_TEST, data_dir, data_dir_test, dimensions, epsilon=0, kpca='no', projection='pca', filter_type=None,
	...
	: param kpca: Whether or not to use kpca.  This is an outdated parameter.
